...
SERVICE_NAME="coc_dhole_house_dev_3001"
...
ExecStart=/usr/bin/npm run dev -- --port 3001 --host --strictPort
Restart=on-failure
RestartSec=5s
...
if [ $? -eq 0 ]; then
    echo "Service ${SERVICE_NAME} created and started on port 3001."
